// Copyright 2017 sumai Author. All Rights Reserved.
//
...
// Package glog provide a general log interface
// Usage:
//
// import "github.com/sumaig/glog"
//
//	log := NewLogger(10000)
...
func (bl *GoLogger) Async(msgLen ...int64) *GoLogger {
	bl.lock.Lock()
...
func (bl *GoLogger) setLogger(adapterName string, configs ...string) error {
...
func (bl *GoLogger) DelLogger(adapterName string) error {
	bl.lock.Lock()
	defer bl.lock.Unlock()
	outputs := []*nameLogger{}
...
func (bl *GoLogger) writeToLoggers(when time.Time, msg string, level int) {
	for _, l := range bl.outputs {
...
func (bl *GoLogger) Write(p []byte) (n int, err error) {
	if len(p) == 0 {
		return 0, nil
	}
...
func (bl *GoLogger) writeMsg(logLevel int, msg string, v ...interface{}) error {
	if !bl.init {
		bl.lock.Lock()
		bl.setLogger(AdapterConsole)
		bl.lock.Unlock()
...
func (bl *GoLogger) SetLevel(l int) {
	bl.level = l
}

// SetLogFuncCallDepth set log funcCallDepth
func (bl *GoLogger) SetLogFuncCallDepth(d int) {
	bl.loggerFuncCallDepth = d
}

// GetLogFuncCallDepth return log funcCallDepth for wrapper
func (bl *GoLogger) GetLogFuncCallDepth() int {
	return bl.loggerFuncCallDepth
}

// EnableFuncCallDepth enable log funcCallDepth
func (bl *GoLogger) EnableFuncCallDepth(b bool) {
	bl.enableFuncCallDepth = b
}

// start logger chan reading.
// when chan is not empty, write logs.
func (bl *GoLogger) startLogger() {
	gameOver := false
	for {
		select {
		case bm := <-bl.msgChan:
...
func (bl *GoLogger) Emergency(format string, v ...interface{}) {
...
func (bl *GoLogger) Alert(format string, v ...interface{}) {
...
func (bl *GoLogger) Critical(format string, v ...interface{}) {
...
func (bl *GoLogger) Error(format string, v ...interface{}) {
...
func (bl *GoLogger) Warning(format string, v ...interface{}) {
...
func (bl *GoLogger) Notice(format string, v ...interface{}) {
...
func (bl *GoLogger) Informational(format string, v ...interface{}) {
...
func (bl *GoLogger) Debug(format string, v ...interface{}) {
...
func (bl *GoLogger) Warn(format string, v ...interface{}) {
	if LevelWarn > bl.level {
		return
	}
	bl.writeMsg(LevelWarn, format, v...)
...
func (bl *GoLogger) Info(format string, v ...interface{}) {
	if LevelInfo > bl.level {
		return
	}
	bl.writeMsg(LevelInfo, format, v...)
...
func (bl *GoLogger) Trace(format string, v ...interface{}) {
	if LevelDebug > bl.level {
		return
	}
	bl.writeMsg(LevelDebug, format, v...)
